package com.zheng.order.service.center;
...
public interface MyOrdersService {
   ...
   public JsonResult checkUserOrder(@RequestParam("userId") String userId, @RequestParam("orderId")  String orderId);
